...
const Footer = () => {
  return (
    <footer className="bg-[#f9f9f9] dark:bg-slate-900 text-gray-700 dark:text-white py-10">
      <div className="container mx-auto px-4 max-w-[1280px] grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2">
            <li className="flex items-center gap-2 transition-all duration-300 hover:text-[#C61F1F] cursor-pointer">
